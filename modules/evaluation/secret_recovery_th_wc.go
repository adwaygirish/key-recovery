...
// shares
func EvaluateWCTwoLayeredThresholdedOptUsedIndisRecovery(
	cfg *configuration.SimulationConfig,
	mainDir string) {
	testCases, dirSubstr := GenerateTestCasesThresholded(1, 1, true, cfg)
	moreTestCases, _ := GenerateTestCasesThresholded(8, 1, true, cfg)
...
func EvaluateWCTwoLayeredThresholdedOptUsedIndisRecoveryVaryingThreshold(
	cfg *configuration.SimulationConfig,
	mainDir string) {
...
func EvaluateWCTwoLayeredThresholdedOptUsedIndisRecoveryVaryingAT(
	cfg *configuration.SimulationConfig,
	mainDir string) {
...
func EvaluateWCTwoLayeredThresholdedOptUsedIndisRecoveryVaryingTrustees(
	cfg *configuration.SimulationConfig,
	mainDir string) {
...
func EvaluateWCTwoLayeredThresholdedOptUsedIndisRecoveryVaryingSS(
	cfg *configuration.SimulationConfig,
	mainDir string) {

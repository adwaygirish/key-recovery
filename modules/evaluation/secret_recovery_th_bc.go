...
// shares
func EvaluateBCTwoLayeredThresholdedOptUsedIndisRecovery(
...
func EvaluateBCTwoLayeredThresholdedOptUsedIndisRecoveryVaryingThreshold(
	cfg *configuration.SimulationConfig,
	mainDir string) {
...
func EvaluateBCTwoLayeredThresholdedOptUsedIndisRecoveryVaryingAT(
	cfg *configuration.SimulationConfig,
	mainDir string) {
...
func EvaluateBCTwoLayeredThresholdedOptUsedIndisRecoveryVaryingTrustees(
	cfg *configuration.SimulationConfig,
	mainDir string) {
...
func EvaluateBCTwoLayeredThresholdedOptUsedIndisRecoveryVaryingSS(
	cfg *configuration.SimulationConfig,
	mainDir string) {

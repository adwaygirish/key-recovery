...
func EvaluateBCBasicHashedSecretRecovery(
	cfg *configuration.SimulationConfig,
	mainDir string) {
...
func EvaluateBCTwoLayeredAdditiveOptUsedIndisRecoveryVaryingThreshold(
	cfg *configuration.SimulationConfig,
	mainDir string) {
...
func EvaluateBCBasicHashedSecretRecoveryVaryingThreshold(
	cfg *configuration.SimulationConfig,
	mainDir string) {
...
// constant with the
func EvaluateBCTwoLayeredAdditiveOptUsedIndisRecoveryVaryingTrustees(
	cfg *configuration.SimulationConfig,
	mainDir string) {
...
func EvaluateBCBasicHashedSecretRecoveryVaryingTrustees(
	cfg *configuration.SimulationConfig,
	mainDir string) {
...
// In this run of experiments, we evaluate the time taken based on the
// changing absolute threshold and changing number of subsecrets
func EvaluateBCTwoLayeredAdditiveOptUsedIndisRecoveryVaryingAT(
	cfg *configuration.SimulationConfig,
	mainDir string) {
...
func EvaluateBCTwoLayeredAdditiveOptUsedIndisRecoveryVaryingSS(
	cfg *configuration.SimulationConfig,
	mainDir string) {
...
func EvaluateBCTwoLayeredAdditiveOptUsedIndisRecoveryOptPerSS(
	cfg *configuration.SimulationConfig,
	mainDir string) {
